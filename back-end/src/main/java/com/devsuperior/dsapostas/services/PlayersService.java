...
public class PlayersService {
	...
	/*
	 * @Transactional public PlayersDTO insert(PlayersDTO dto) { Players entity =
	 * new Players(); entity.setName(dto.getName()); Não entendi aqui! entity =
	 * repository.save(entity); return new PlayersDTO(entity); }
	 */
	
	public Players findX(Long id) {
